...
function TopBar() {
        ...
        async (snapshot) => {
          const updatedReportUsers = await Promise.all(
            snapshot.docs.map(async (doc) => {
              ...
              const createdAt = new Date(reportUserData.createdAt.toDate());
              //console.log(reportUserData.createdAt.toDate())
          ...
          const filteredUsers = updatedReportUsers
            .filter((tag) => {
  ...
  const handleDeleteNoti = (id) => {
    try {
      reportUsersCollection.doc(id).update({
        isOpen: true,
      });
      //console.log("run...");
    } catch (error) {
            ...
            >
              ...
              >
                ...
                >
                  ...
                  {messageData.filter((tag) => tag.isOpen === false) ? (
                    <>
                          ...
                          <ListItem alignItems="flex-start">
                            ...
                            <ListItemIcon>
                              <IconButton
                                ...
                                aria-label="delete"
                                onClick={() =>
                                  handleDeleteNoti(notification.id)
                                }
                              >
