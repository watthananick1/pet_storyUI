...
export default function Sidebar() {
  ...
  const handleDeleteTypePet = async (type) => {
    await UsersCollection.doc(user.member_id).update({
      typePets: firebase.firestore.FieldValue.arrayRemove(type?.nameType)
    });
    const typePet = await UsersCollection.doc(user.member_id).get();
    setTypePets(typePet.typePets);
  };
