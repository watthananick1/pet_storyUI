...
export default function Sidebar() {
  ...
  useEffect(() => {
    ...
    if (typePets && typePets.some((type) => type.nameType === tes.nameType)) {
      if (selectedTypes.includes(tes.nameType)) {
        setSelectedTypes((prevState) =>
          prevState.filter((id) => id !== tes.nameType)
        );
      } else {
        setSelectedTypes((prevState) => [...prevState, tes.nameType]);
      }
    }
    let outs = [
    ...typePets,
    ...
    console.log('selectedTypes'outs)
  }, [typePets]);
