    ...
    try {
      Swal.fire({
        ...
        if (result.isConfirmed) {
          ...
          setTypePets(prevTypePets => prevTypePets.filter(type => type.nameType !== typeName));
          Swal.fire(
            'Deleted!',
            ...
            {typePets.map((type, index) => (
              <React.Fragment key={index}>
                <ListItem
                  ...
                  secondaryAction={
                    <IconButton edge="end" aria-label="delete" onClick={() => handleDeleteTypePet(type.nameType)}>
                      <DeleteIcon />
                    </IconButton>
                  }
                >
