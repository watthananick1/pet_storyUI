...
export default function Sidebar() {
  ...
  useEffect(() => {
    ...
    if (typePets.nameType && !selectedTypes.includes(typePets.nameType)) {
      setSelectedTypes((prevState) => [...prevState, typePets.nameType]);
    }
  ...
  const isButtonPressed = (typePetId) => selectedTypes.includes(typePetId) || typePets.includes(typePetId);
  const isTypeSelected = typePets.some((type) => type.nameType === selectedTypes.nameType);
