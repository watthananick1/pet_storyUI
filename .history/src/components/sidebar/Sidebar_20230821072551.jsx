  ...
  useEffect(() => {
    ...
    if (typePets) {
      typePets.forEach((typePet) => {
        if (typePet.nameType && selectedTypes.includes(typePet.nameType)) {
          setSelectedTypes((prevState) =>
            prevState.filter((id) => id !== typePet.nameType)
          );
        } else if (typePet.nameType && !selectedTypes.includes(typePet.nameType)) {
          setSelectedTypes((prevState) => [...prevState, typePet.nameType]);
        }
      });
    }
