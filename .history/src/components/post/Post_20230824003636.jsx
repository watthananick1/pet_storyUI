...
export default function Post({ isPost, onPostUpdate, indexPost }) {
  ...
  const handlePostUpdate = async (updatedPost, type) => {
    ...
    if (type === "Post") {
      ...
      // setComments((prevComments) => {
      //   const updatedComments = [...prevComments]; 
      //   updatedComments = [...prevComments, updatedPost]; 
  ...
  const handleDeleteComment = async () => {
    ...
    try {
      ...
      //   }
      // );
      const CommentRef = firebase.db.collection("Comments").doc(commentIdToDelete);
      const PostRef = firebase.db.collection("Comments").doc(commentIdToDelete);
