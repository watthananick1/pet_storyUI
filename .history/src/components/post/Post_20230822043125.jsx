    ...
    <div className="post" key={indexPost}>
      <Card className="postWrapper">
        ...
        <div className="postBottom">
          ...
          <Accordion expanded={showComments} onChange={() => setShowComments(!showComments)}>
  <AccordionSummary expandIcon={<ExpandMoreIcon />} aria-controls="comment-content" id="comment-header">
  </AccordionSummary>
  <AccordionDetails>
            <CardActions disableSpacing>
              ...
              <Comment style={{ color: "#6200E8" }} sx={{ mr: 1, ml: 1 }} />
              <span style={{ marginLeft: "5px" }} className="postLikeCounter">
                {" "}
                 {comments.length}{" "}
              </span>
            </CardActions>
