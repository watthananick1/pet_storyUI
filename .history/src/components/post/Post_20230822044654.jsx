        ...
        <div className="postBottom">
          <div className="postBottomLeft">
            <CardActions >
              ...
              <Comment style={{ color: "#6200E8" }} sx={{ mr: 1, ml: 1 }} onClick={() => setShowComments(!showComments)} />
              <Typography style={{ marginLeft: "5px" }} className="postLikeCounter" onClick={() => setShowComments(!showComments)}>
                {" "}
