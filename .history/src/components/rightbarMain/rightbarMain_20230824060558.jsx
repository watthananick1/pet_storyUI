...
export function Rightbar({ user }) {
  ...
  //     const currentUserRef = firestore.collection("Users").doc(currentUser?.member_id);
  ...
  //           followings: firebase.firestore.FieldValue.arrayRemove(user?.member_id),
  //         });
  
  //         await userRef.update({
  //           followers: firebase.firestore.FieldValue.arrayRemove(currentUser?.member_id),
  //         });
  //       } else {
  //         // Follow the user
  //         await currentUserRef.update({
  //           followings: firebase.firestore.FieldValue.arrayUnion(user?.member_id),
  //         });
  
  //         await userRef.update({
  //           followers: firebase.firestore.FieldValue.arrayUnion(currentUser?.member_id),
  //         });
  //       }
