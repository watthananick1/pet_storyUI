...
export default function FromTypePets({ selectedTypePet }) {
  ...
  useEffect(() => {
    if (selectedTypePet) {
      setNameType(selectedTypePet.nameType);
      setStatus(selectedTypePet.status);
      setImagePreview(selectedTypePet.imgPet);
    }
  }, [selectedTypePet]);
  ...
  const handleAvatarUpload = async () => {
    ...
    if (!nameType || nameType === null || nameType ){
      Swal.fire(
        "กรุณากรอกชื่อประเภทสัตว์",
        "กรุณากรอกชื่อประเภทสัตว์ครบถ้วนก่อน แล้วดำเนินการใหม่อีกครั้ง",
        "warning"
      );
      return;
    }
    ...
    try {
      ...
      Swal.fire({
        title: "สำเร็จ!",
        text: "ได้ทำการบันทึกข้อมูลให้ท่านแล้ว",
        icon: "success",
          ...
          {selectedTypePet ? (
            <>
              ...
              <Typography color="primary" sx={{ p: 2 }} variant="h5">
                Selected TypePet: {selectedTypePet.nameType}
              </Typography>
            </>
          ) : (
            <Typography color="primary" sx={{ p: 2 }} variant="h5">
          ...
          <Grid container spacing={3}>
            ...
            <Grid item xs={12} md={8}>
              {selectedTypePet ? (
                ...
                // แสดงปุ่ม Save เมื่อไม่ได้เลือก TypePet
                <LoadingButton
                  loading={loading}
                  fullWidth
