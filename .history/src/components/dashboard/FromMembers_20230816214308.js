...
export default function FromMembers({ selectedMember }) {
  ...
  const [นpenBlockDialog, setOpenBlockDialog] = useState(false);
    ...
    if (selectedMember.status === "blog") {
      ...
      if (now > expirationDate) {
        ...
        const timeout = setTimeout(() => {
          ...
          handleBlock(); // Call the function to show the block dialog
  ...
  const handleConfirmBlock = () => {
    ...
    // Update status to "active" after blocking
    setStatus("active");
    // ... update Firestore or perform other necessary actions ...
                  ...
                  control={
                    <IOSSwitch
                      ...
                      onChange={(e) => {
                        ...
                        if (!e.target.checked) {
                          handleBlock(); // Open block dialog if switching to "blog"
                        }
                      }}
                    />
                  }
