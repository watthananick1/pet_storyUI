        ...
        async (snapshot) => {
          const updatedReportUsers = await Promise.all(
            snapshot.docs.map(async (doc) => {
              ...
              const createdAtTimestamp = reportUserData.createdAt && reportUserData.createdAt.timestamp;
              const createdAt = createdAtTimestamp ? createdAtTimestamp.seconds * 1000 : 0;
          ...
          <AppBar position="absolute" open={open}>
            ...
            >
                      ...
                      <ListItemText
                        primary={
                          <>
                            <Typography variant="subtitle1" color="secondary" noWrap>
                              {notification.reporter_firstName} {notification.reporter_lastName}
                            </Typography>
                        ...
                        secondary={
                          <>
                            ...
                            >
                              {format(notification.createdAt.toDate(), "dd MMMM yyyy")}
              ...
              <IconButton color="inherit" onClick={(event) => handleClickReadNoti(event.currentTarget)}>
                <Badge
                  badgeContent={messageData.length}
                  color="error"
                >
                  <NotificationsIcon />
                </Badge>
