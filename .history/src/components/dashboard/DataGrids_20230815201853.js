...
const columns = [
  ...
  },
  {
    ...
    renderCell: (params) => {
      switch (params.value) {
        case "in progress": // Replace "value" with the actual value you want to compare
          return (
            <Typography variant="subtitle2" color="InfoText" gutterBottom>
              in progress
            </Typography>
          );
        case "is checking": // Replace "value" with the actual value you want to compare
          return (
            <Typography variant="subtitle2" color="w" gutterBottom>
              in progress
            </Typography>
          );
        default:
