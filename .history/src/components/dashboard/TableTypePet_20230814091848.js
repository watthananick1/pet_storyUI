...
const columns = [
  ...
  },
  {
    ...
    renderCell: (params) => (
        <Chip
          label={params.value ? "Active" : "Inactive"} // แสดง "Active" หรือ "Inactive" ขึ้นอยู่กับค่าของ status
          color={params.value ? "primary" : "default"} // กำหนดสีของ Chip ในแบบ Active หรือ Inactive
        />
      ),
  },
];
