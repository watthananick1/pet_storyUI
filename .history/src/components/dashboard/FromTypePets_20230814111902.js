...
const imageRef = storageRef.child(`images/TypePets/${Date.now()}_${nameType}.jpg`);
      ...
      const newTypePetData = {
        ...
        imgPet: downloadUrl,
        nameType: nameType, // หรือ req.body.nameType ถ้าคุณใช้ Express.js
        status: status, // หรือ req.body.status ถ้าคุณใช้ Express.js
      };
  ...
  return (
    ...
    >
      ...
      >
        <FormGroup>
        <Typography color="primary" sx={{p: 2}} variant="h5" >Add Type Pet</Typography>
