...
export default function Feed({ firstName, onProfile }) {
  ...
  //   //     setPosts((prevPosts) => [newPosts, ...prevPosts]); // ให้เพิ่มเฉพาะโพสต์แรกของ newPosts
  //   //   }
  //   // }
    ...
    try {
      unsubscribe = postsCollection
        ...
        .onSnapshot(async (snapshot) => {
          ...
          setPosts((prevPosts) => [filteredPosts, ...prevPosts]); // อัพเดต state posts เพื่อแสดงผลใหม่ใน Feed
        });
    } catch (error) {
