...
export default function Feed({ firstName, onProfile }) {
  ...
  open={open}
  anchorEl={anchorEl}
  placement="top" // แสดงที่ด้านบน
  modifiers={[
    {
      name: 'offset',
      options: {
        offset: [0, 10], // ปรับข้อความแสดงให้อยู่กลางจอ
      },
    },
  ]}
  transition
>
  {({ TransitionProps }) => (
    <Fade {...TransitionProps} timeout={350}>
      <div className="floating-chip"> {/* ให้ Popper แสดงบนสุดและกลาง */}
        <Chip
          label={`Have new ${countPost} post.`}
