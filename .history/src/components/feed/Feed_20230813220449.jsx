...
export default function Feed({ firstName, onProfile, sort }) {
  ...
  const fetchPosts = async () => {
    ...
    try {
      ...
      setLoading(true);
      isSetOpen(false);
      const res = await axios.get(`${path}/api/posts/${user.member_id}/${sort}`, {
        headers: {
  ...
  const fetchUserPosts = async () => {
    try {
      ...
      isSetOpen(false);
      setLoading(true);
      const res = await axios.get(`${path}/api/posts/user/${firstName}/${sort}`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
  ...
  useEffect(() => {
    ...
    const fetchPosts = async () => {
      try {
        ...
        const res = await axios.get(
          `${path}/api/posts/${user.member_id}/${sort}`,
          {
            headers: {
              Authorization: `Bearer ${token}`,
            },
    ...
    const fetchUserPosts = async () => {
      try {
        ...
        isSetOpen(false);
        const res = await axios.get(
          `${path}/api/posts/user/${firstName}/${sort}`,
          {
            headers: {
              Authorization: `Bearer ${token}`,
            },
  ...
  }, [onProfile, firstName, user.member_id, newPosts, sort]);
