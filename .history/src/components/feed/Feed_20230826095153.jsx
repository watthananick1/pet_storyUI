    ...
    try {
      ...
      if (error.response) {
        if (error.response.status === 404 && error.response.data.message === "User not found") {
          ...
          console.log("User not found. Displaying appropriate message to the user.");
          ...
          setErrorMessage("An error occurred while fetching user posts. Please try again later.");
        }
