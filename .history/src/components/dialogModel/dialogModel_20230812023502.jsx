...
export default function FilePreviewer({ onClose }) {
  ...
  const [crop, setCrop] = useState({
    ...
    height: 50, // Initial crop height (percentage)
  });
  ...
  const getCroppedProfileImageBlob = async (sourceImageUrl, crop, profileSize) => {
    ...
    return new Promise((resolve) => {
        image.onload = () => {
            ...
            const newHeight = scaledHeight < image.height ? scaledHeight : image.height;
            ...
            canvas.width = profileSize.width; // Set canvas width to the desired profile picture width
            canvas.height = profileSize.height; // Set canvas height to the desired profile picture height
