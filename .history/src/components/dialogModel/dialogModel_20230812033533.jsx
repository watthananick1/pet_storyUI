...
export default function FilePreviewer({ onClose }) {
  ...
  const handleAvatarUpload = async () => {
    ...
    try {
      ...
      //   upImg, // Use the upImg state which holds the cropped image data
      //   completedCrop, // Use the completedCrop state which holds the crop coordinates
      //   profileSize
      // );
      ...
      const file = new File([previewCanvasRef], fileName, {
        type: "image/jpeg",
      });
