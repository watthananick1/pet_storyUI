  ...
  const renderMenu = (
    ...
    >
      ...
      {user.statusUser === "ADMIN" && (
        <MenuItem component={NavLink} to={/profile/${firstName}>
          <ListItemIcon>
      ...
      {user.statusUser === "ADMINCON" && (
        <MenuItem onClick={handleDashboardCONClick}>
          <ListItemIcon>
            <DashboardIcon fontSize="small" />
          </ListItemIcon>
          Dashboard
            ...
            >
              <span className="logo">
                <IconButton component={NavLink} to="/">
                  <Avatar sx={{ m: 1 }} src="/assets/P.png"></Avatar>
                </IconButton>
              </span>
            </Typography>
            <Search>
