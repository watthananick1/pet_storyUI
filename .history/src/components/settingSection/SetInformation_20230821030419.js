...
export default function SetInformation() {
  ...
  const [selectedDate, setSelectedDate] = useState(dayjs(currentUser.dateOfBirth) ?? null);
              ...
              <Grid item xs={12} md={12} lg={12}>
                <LocalizationProvider dateAdapter={AdapterDayjs}>
                  <DatePicker
                    ...
                    defaultValue={dayjs(currentUser.dateOfBirth).format('DD/MM/YYYY') ?? null}
                  />
