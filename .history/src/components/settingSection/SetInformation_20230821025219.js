...
export default function SetInformation() {
  ...
  useEffect(() => {
    console.log(dayjs(currentUser.dateOfBirth).format("YYYY-MM-DD"));
              ...
              <Grid item xs={12} md={12} lg={12}>
                <LocalizationProvider dateAdapter={AdapterDayjs}>
                  <DatePicker
                    ...
                    defaultValue={currentUser.dateOfBirth ? moment(currentUser.dateOfBirth.toDate()).format("YYYY-MM-DD") : null}
                  />
