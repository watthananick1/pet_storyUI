...
import Card from "@mui/material/AvatarGroup";
...
export function RightbarR({ user }) {
  ...
  const ProfileRightbar = () => {
    return (
      ...
      <Card></Card>
        {user?.firstName !== currentUser?.firstName && (
          <button className="rightbarFollowButton" onClick={handleClick}  style={{ marginBottom: "10px"}}>
            {followed ? "Unfollow" : "Follow"}
            {followed ? <Remove /> : <Add />}
          </button>
        )}
        <h4 className="rightbarTitle"  style={{ marginBottom: "10px"}}>User information</h4>
        <div className="rightbarInfo"  style={{ marginBottom: "10px"}}>
          <div className="rightbarInfoItem"  style={{ marginBottom: "10px"}}>
            <span className="rightbarInfoKey"  style={{ marginBottom: "10px"}}>City:</span>
            <span className="rightbarInfoValue"  style={{ marginBottom: "10px"}}>
              {user.city ? user?.city : "-"}
            </span>
          </div>
          <div className="rightbarInfoItem"  style={{ marginBottom: "10px"}}>
            <span className="rightbarInfoKey"  style={{ marginBottom: "10px"}}>From:</span>
            <span className="rightbarInfoValue"  style={{ marginBottom: "10px"}}>
              {user.from ? user?.from : "-"}
            </span>
          </div>
          <div className="rightbarInfoItem"  style={{ marginBottom: "10px"}}>
            <span className="rightbarInfoKey"  style={{ marginBottom: "10px"}}>Relationship:</span>
            <span className="rightbarInfoValue"  style={{ marginBottom: "10px"}}>
              {user?.relationship === 1
                ? "Single"
                : user?.relationship === 1
        ...
        <h4 className="rightbarTitle"  style={{ marginBottom: "10px"}}>User friends</h4>
        <div className="rightbarFollowings"  style={{ marginBottom: "10px"}}>
