...
export default function Rightbar({ user }) {
  ...
  const [Onlinefriends, setOnlinfFriends] = useState(null);
  ...
  useEffect(() => {
    ...
    // หลังจากเสร็จสิ้นลูป อัปเดต Online Friends ทั้งหมดในครั้งเดียว
    ...
    return (
      <>
        ...
        <ul className="rightbarFriendList">
          {Onlinefriends.map((u) => {
            console.log('user',u[0].member_id); // ใช้ในส่วนของ JavaScript
