...
import { Messageupdate, AddComment } from "../../context/AuthActions";
      ...
      try {
        ...
        if (onTitle === "Post") {
          ...
          try {
            ...
            const postRef = firebase.db.collection("Posts").doc(onContentID);
            await postRef.update({
              comments: firebase.firestore.FieldValue.arrayRemove(commentIdToDelete),
            });
            ...
            // After successfully adding the comment, you might want to update the comments in your state
            // Dispatch an action to update the comments in your state or trigger a re-render
            // const commentRef = firestore.collection("Comments").doc(onContentID);
            // const commentSnapshot = await commentRef.get();
            // const newComment = commentSnapshot.data();
            
            // dispatch(AddComment(newComment));
            //onContentData((data) => [...data, ...newComment]);
