...
import { AuthContext, Messageupdate } from "../../context/AuthContext";
...
export default function Share({ onNewPost }) {
  ...
  const submitHandler = async (e) => {
    ...
    try {
      ...
      dispatch(
        Messageupdate("This is a success message.", true, "success")
      );
  ...
  useEffect(() => {
    const getTypePets = async () => {
      try {
        ...
        dispatch({ type: "MESSAGE_UPDATE", message: "Failed get type pets.", open: true, severity: "error"});
        console.log(err);
      }
    };
    getTypePets();
