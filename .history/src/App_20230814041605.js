  ...
  return (
    <Router>
      <Switch>
        ...
        <Route path="/dashboard" component={user && user.statusUser === "ADMIN" ||user && user.statusUser === "ADMINCON" ? AdminModel : Home} />
        <Route path="/register" component={Register} />
        <Route path="/profile/:firstName" component={user ? Profile : Login} />
        <Route path="/sort/:sort/:typePet" component={user ? Sort_feed : Login} />
