            ...
            <Grid container spacing={2}>
              ...
              <Grid item xs={12}>
                <TextField
                  ...
                  autoComplete="email"
                  error={!emailError}
                  helperText={!emailError ? "กรุณากรอกอีเมลให้ถูกต้อง" : "ตัวอย่าง: example@example.com"}
              ...
              <Grid item xs={12}>
                <TextField
                  ...
                  helperText={!passwordConfirmError ? "กรุณากรอกยืนยันรหัสผ่านให้ถูกต้อง" : "กรุณาใส่รหัสผ่านให้ตรงกัน"}
                  InputProps={{
                    endAdornment: (
                      <InputAdornment position="end">
              ...
              <Grid item xs={12}>
                <LocalizationProvider dateAdapter={AdapterDayjs}>
                  <DatePicker
                    format="DD/MM/YYYY"
                    value={selectedDate}
                    helperText={!passwordConfirmError ? "กรุณากรอกยืนยันรหัสผ่านให้ถูกต้อง" : "เพื่อความถูกต้องกรุณาเลือกผ่านไอคอนปฏิทิน"}
                    onChange={handleDateChange}
                  />
                  <Typography variant="caption" display="block" gutterBottom>
                  เพื่อความถูกต้องกรุณาเลือกผ่านไอคอนปฏิทิน
      </Typography>
