...
export default function SignUp() {
  ...
  const isValidPasswordConfirm = (confirmedpassword) => {
    if (password !== confirmedpassword) {
      setPasswordConfirmError(!isValidPasswordConfirm());
    }
  };
  ...
  const handlePasswordConfirmChange = (confirmedPassword) => {
    setPasswordConfirmError(isValidPassword(confirmedPassword));
    if (password !== confirmedPassword) {
            ...
            <Grid container spacing={2}>
              ...
              <Grid item xs={12}>
                <TextField
                  ...
                  error={!emailError}
                  helperText={!emailError ? "กรุณากรอกยืนยันรหัสผ่านให้ถูกต้อง" : ""}
                  InputProps={{
                    endAdornment: (
                      <InputAdornment position="end">
