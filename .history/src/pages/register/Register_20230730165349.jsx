...
export default function SignUp() {
  ...
  const formatDate = (date) => {
    if (date) {
      return dayjs(date).format('DD/MM/YYYY'); // Format the date to "dd/MM/YYYY"
    }
    return '';
  };
  ...
  const handleSubmit = (event) => {
    ...
    if (password !== confirmedPassword) {
      ...
      console.log({
        ...
        dateOfbirth: formatDate(selectedDate.d.toString()
      });
    }
            ...
            <Grid container spacing={2}>
              ...
              <Grid item xs={12}>
                <TextField
                  ...
                  type={showPasswordConfirmation ? "text" : "password"} // Toggle between 'text' and 'password' type
