...
export default function SignUp() {
  ...
  const isValidFirstName = (firstName) => {
    ...
    // อื่น ๆ ตามเงื่อนไขการตรวจสอบชื่อที่คุณต้องการ
    // เช่น ต้องไม่มีตัวเลข ตัวอักษรพิเศษ เป็นต้น
    // คืนค่า true ถ้าชื่อถูกต้อง หรือ false ถ้าไม่ถูกต้อง
    return true;
  };
  
  // ตรวจสอบว่านามสกุลถูกต้องหรือไม่
  const isValidLastName = (lastName) => {
    // ตรวจสอบว่านามสกุลไม่เป็นค่าว่าง
    if (!lastName.trim()) {
      return false;
    }
    // อื่น ๆ ตามเงื่อนไขการตรวจสอบนามสกุลที่คุณต้องการ
    // เช่น ต้องไม่มีตัวเลข ตัวอักษรพิเศษ เป็นต้น
    // คืนค่า true ถ้านามสกุลถูกต้อง หรือ false ถ้าไม่ถูกต้อง
    return true;
  };
            ...
            <Grid container spacing={2}>
              ...
              <Grid item xs={12}>
                <LocalizationProvider dateAdapter={AdapterDayjs}>
                  ...
                  />
                  <Typography variant="caption" color="gray" display="block" gutterBottom>
