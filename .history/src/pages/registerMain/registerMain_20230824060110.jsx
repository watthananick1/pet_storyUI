  ...
  const handleSubmit = async (event) => {
    ...
    if (!selectedDate) {
      Swal.fire(
        ...
        "กรุณากรอกวัน/เดือน/ปีเกิดก่อน แล้วดำเนินการใหม่อีกครั้ง",
        "warning"
      );
      return;
    }
    ...
    if (password !== confirmedPassword) {
      ...
      try {
        await signUpCall(userData, dispatch, history);
      } catch (error) {
        ...
        Swal.fire({
          title: "สำเร็จ!",
          text: "ท่านได้สมัครสมาชิกสำเร็จแล้ว ต่อไปกรุณาเลือกประเภทสัตว์ที่ต้องการ",
          icon: "success",
